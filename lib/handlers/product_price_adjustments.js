...
const baseAdjustmentAttributes = {
  product_id: Joi.string().required().description('Identifier of the product the price adjustment applies to'),
  type: Joi.string().required().description('The type of adjustment'),
  amount: Joi.number().description('The percentage or value amount to adjust price by')
};
