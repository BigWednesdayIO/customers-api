...
const baseCustomerSchema = joi.object({
  ...
  default_sign_for: joi.boolean().description('The default value for the "sign for delivery" radio buttons in checkout'),
  addresses: joi.array().items(
    joi.object({
      ...
      default_delivery: joi.boolean().description('Flag for one address to be the default for delivery'),
      default_billing: joi.boolean().description('Flag for one address to be the default for billing')
